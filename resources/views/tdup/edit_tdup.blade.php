...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Ubah TDUP</a></li>
    </ol>
</section>
                ...
                <div class="box-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6" style="padding: 0;">
                            ...
                            <input name="tgl_verifikasi" type="date" class="form-control" id="tgl_verifikasi" @if($tdup -> tgl_verifikasi == null) value="{{$tdup -> tgl_verifikasi}}" @else value="{{$tdup -> tgl_verifikasi ->
