                                ...
                                <div class="d-flex flex-column align-items-center text-center user">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h5 class="text-muted font-size-sm">
                                            @if(\Auth::guard('user')->user() && \Auth::guard('user')->user()->level == '0') Administrator @elseif(\Auth::guard('user')->user() && \Auth::guard('user')->user()->level == '1') Staf Jasa
                                            Pariwisata @elseif(\Auth::guard('user')->user() && \Auth::guard('user')->user()->level == '2') Kepala Seksi Jasa Pariwisata @endif @if(\Auth::guard('bpw')->user()) Biro Perjalanan Wisata @endif
                                        </h5>
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php
                        if($bpws->status == 0) { echo "Tidak Aktif"; } elseif($bpws->status == 1) { echo "Aktif"; } ?></td>
                                    </tr>
                                    @endif @if(\Auth::guard('user')->user())
                                    <tr>
