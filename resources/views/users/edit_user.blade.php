	...
	<div class="box box-primary">
	  ...
	  <div style="clear: both;"></div>
		...
		<div class="form-group col-md-6" style="padding: 0;">
		    ...
		    <input name="password" type="password" class="form-control" id="input_password" value ="{{$users -> password}}" required="required" autocomplete="off">
		</div>
		</div>
	    ...
	    <div class="form-group col-md-6" style="padding: 0;">
	      	<label for="form_status">Status</label>
		        ...
		        <option value="1" @if($users -> status == "0") selected @endif>Aktif</option>
	    	    <option value="0" @if($users -> status == "1") selected @endif>Tidak Aktif</option>
	      		</select>
	    </div>
	  	</div>
